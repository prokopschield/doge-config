...
class Config extends ConfigField_1.default {
    ...
    __forceField(prop) {
        return __classPrivateFieldGet(this, __data).__forceField(prop);
    }
    __forceString(prop) {
        return __classPrivateFieldGet(this, __data).__forceString(prop);
    }
    __forceNumber(prop) {
        return __classPrivateFieldGet(this, __data).__forceNumber(prop);
    }
    __forceBoolean(prop) {
        return __classPrivateFieldGet(this, __data).__forceBoolean(prop);
    }
    __forceArray(prop) {
        return __classPrivateFieldGet(this, __data).__forceArray(prop);
    }
    __has(prop) {
